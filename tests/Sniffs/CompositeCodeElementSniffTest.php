    ...
    public static function dataProcess(): array
    {
        ...
        $dataSets[] = [
            ...
            [
                ...
                '083 Add type declaration for C1 constant, e.g.: "string".',
                '083 Useless PHPDoc',
                '086 Add type declaration for C2 constant, e.g.: "?SomeClass".',
                '086 Useless PHPDoc',
                ...
                '116 Add type declaration for C3 constant, e.g.: "string" or create PHPDoc with type hint.',
        ...
        $dataSets[] = [
            ...
            [
                '011 Add type declaration for C2 constant, e.g.: "array".',
                '014 Add type declaration for C3 constant, e.g.: "array".',
                '017 Add type declaration for C4 constant, e.g.: "array".',
        ...
        $dataSets[] = [
            ...
            [
                '007 Add type declaration for XXX constant, e.g.: "array" or create PHPDoc with type hint.',
        ...
        $dataSets[] = [
            ...
            [
                '013 Add type declaration for C2 constant, e.g.: "int" or create PHPDoc with type hint.',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '083 Add type declaration for C1 constant, e.g.: "string". [9846fb088b492d42]',
                '083 Useless PHPDoc [81dfff54c0c60d71]',
                '086 Add type declaration for C2 constant, e.g.: "?SomeClass". [0b093a9737b15cc0]',
                ...
                '116 Add type declaration for C3 constant, e.g.: "string" or create PHPDoc with type hint. [67d582ff53f5eafd]',
        ...
        $dataSets[] = [
            ...
            [
                '006 Useless description',
                '008 Useless tag',
                '015 Add type declaration for CONST1 constant, e.g.: "array".',
                '021 Add type declaration for CONST2 constant, e.g.: "array".',
                '025 Missing "array" type in CONST3 constant type hint',
                '028 Add type declaration for CONST3 constant, e.g.: "string".',
                '034 Add type declaration for CONST4 constant, e.g.: "?array".',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '046 Add type declaration for CONST1 constant, e.g.: "\Countable&\IteratorAggregate".',
                '047 Intersection types can only contain class or interfaces names',
                '047 Missing "string" type in CONST2 constant type hint',
                '048 Add type declaration for CONST2 constant.',
                ...
                '094 Add type declaration for CONST3 constant, e.g.: "array".',
                '104 Use null return value type declaration or change type to union, e.g. SomeClass|null',
                '106 Add type declaration for return value, e.g.: "?SomeClass".',
                '111 Add type declaration for return value, e.g.: "false".',
                '116 Add type declaration for return value, e.g.: "true".',
            ],
        ];
        ...
        $dataSets[] = [
            ...
            [
                '007 Add type declaration for CONST1 constant, e.g.: "array" or create PHPDoc with type hint.',
